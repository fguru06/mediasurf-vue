      ...
      <div class="container">
        <div class="cards-grid">
          <div class="mission-card modern-card">
            <div class="card-icon-bg mission-bg"></div>
          ...
          <div class="vision-card modern-card">
            <div class="card-icon-bg vision-bg"></div>
            <div class="card-header">
    ...
    <section class="values-section">
      <div class="container">
        <div class="section-header">
          ...
          <p class="section-subtitle">Core beliefs that shape our approach to every project</p>
        </div>

        <div class="values-grid">
          <div class="value-card">
            <div class="value-icon-wrapper innovation-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <p class="value-description">We stay ahead of the curve with cutting-edge technologies and creative solutions.</p>
          </div>
          
          <div class="value-card">
            <div class="value-icon-wrapper quality-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
              </svg>
            </div>
            <h3 class="value-title">Quality</h3>
            <p class="value-description">Excellence in every project, ensuring the highest standards of delivery.</p>
          </div>
          
          <div class="value-card">
            <div class="value-icon-wrapper collaboration-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <p class="value-description">Working closely with clients to understand and exceed their expectations.</p>
          </div>
          
          <div class="value-card">
            <div class="value-icon-wrapper excellence-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <p class="value-description">Committed to delivering outstanding results that drive measurable impact.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="expertise-section">
      <div class="container">
        <div class="section-header">
          ...
          <p class="section-subtitle">Technologies and solutions we specialize in</p>
        </div>

        <div class="expertise-grid">
          <div v-for="(item, index) in expertise" :key="index" class="expertise-item">
      ...
      <div class="container">
        <div class="cta-content">
          ...
          <div class="cta-buttons">
            ...
            <a href="/#courses" class="cta-button secondary">
              View Services
            </a>
          </div>
        </div>
